...
const MCP = {
  ...
  packageName: "@getmcpads/google-search-console-mcp-server",
  binName: "google-search-console-mcp",
  repoName: "google-search-console-mcp",
  claudeKeys: ["google-search-console-mcp", "gsc-mcp"],
  requiredEnv: [],
  requiredEnvAlternatives: [
    ["GSC_ACCESS_TOKEN"],
    ["GSC_CLIENT_ID", "GSC_CLIENT_SECRET", "GSC_REFRESH_TOKEN"],
  ],
  optionalEnv: ["GSC_SITE_URL", "LOG_LEVEL"],
};
